...
// At campaign battle end, hand all surrendered ships to the VP-winner (capture the
// loser's, recover the winner's own). Postfix runs after vanilla's result/VP reconciliation
