...
// Pure logging, no game state is modified. Every line is prefixed "UADVP_PROBE"
...
[HarmonyPatch]
internal static class UADVP_DiagnosticProbePatch
{
    ...
    private static void Log(string msg) => Melon<UADVanillaPlusMod>.Logger.Msg("UADVP_PROBE " + msg);
