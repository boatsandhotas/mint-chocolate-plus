...
internal static class MinelayerGoals
{
    ...
    internal static Goal Load()
    {
        ...
        {
            Melon<UADVanillaPlusMod>.Logger.Warning($"UADVP minelayer goals: load failed — {ex.GetType().Name}: {ex.Message}");
        }
        return g;
    }
    ...
    internal static void Save(Goal g)
    {
        ...
        {
            Melon<UADVanillaPlusMod>.Logger.Warning($"UADVP minelayer goals: save failed — {ex.GetType().Name}: {ex.Message}");
        }
    }
