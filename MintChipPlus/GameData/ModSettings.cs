...
// MC philosophy: balance-affecting features should be controlled in-game, not
// through loose config files. Balance changes default to MC's improved behavior
// while letting players opt back into vanilla rules from the UAD:MC menu.
internal static class ModSettings
{
    private const string PortStrikeBalancedKey = "uadmc_port_strike_balanced";
    private const string AiFleetCompositionModeKey = "uadmc_ai_fleet_composition_mode";
    private const string AdvancedAiBuilderEnabledKey = "uadmc_advanced_ai_builder_enabled";
    private const string SmartAiDesignsEnabledKey = "uadmc_smart_ai_designs_enabled";
    private const string SharedDesignsOnlyModeKey = "uadmc_shared_designs_only_mode";
    private const string SmartRefitsEnabledKey = "uadmc_smart_refits_enabled";
    private const string SeaTransportLossesActiveForcesKey = "uadmc_sea_transport_losses_active_forces";
    private const string AiTaskForceStagingEnabledKey = "uadmc_ai_task_force_staging_enabled";
    private const string CampaignNavalMobilityModeKey = "uadmc_campaign_naval_mobility_mode";
    private const string TaskForceSustainmentFullKey = "uadmc_task_force_sustainment_full";
    private const string BattleWeatherAlwaysSunnyKey = "uadmc_battle_weather_always_sunny";
    private const string BattleSpottingRangeModeKey = "uadmc_battle_spotting_range_mode";
    private const string BattleDamageModeKey = "uadmc_battle_damage_mode";
    private const string RealisticShellDamageModeKey = "uadmc_realistic_shell_damage_mode";
    private const string DesignAccuracyPenaltyModeKey = "uadmc_design_accuracy_penalty_mode";
    private const string HullSpeedAdjustmentEnabledKey = "uadmc_hull_speed_adjustment_enabled";
    private const string HullWeightAdjustmentEnabledKey = "uadmc_hull_weight_adjustment_enabled";
    private const string MajorShipTorpedoesRestrictedKey = "uadmc_major_ship_torpedoes_restricted";
    private const string BattleReverseMethodKey = "uadmc_battle_reverse_method";
    private const string FollowSteerDampingEnabledKey = "uadmc_follow_steer_damping_enabled";
    private const string ParallelStationAbreastKey = "uadmc_parallel_station_abreast";
    private const string AiEconomyPrioritiesKey = "uadmc_ai_economy_priorities";
    private const string ShipResupplyOverrideKey = "uadmc_ship_resupply_override";
    private const string ShipServiceRecordsKey = "uadmc_ship_service_records";
    private const string SuperstructureRefitsEnabledKey = "uadmc_superstructure_refits_enabled";
    private const string ShipyardCapacityBalancedKey = "uadmc_shipyard_capacity_balanced";
    private const string MultiYearShipyardRebuildKey = "uadmc_multiyear_shipyard_rebuild";
    private const string VanquishedSpoilsKey = "uadmc_vanquished_spoils";
    private const string RebuildOverseasWeightKey = "uadmc_rebuild_overseas_weight";
    private const string VanquishedSpoilsShareKey = "uadmc_vanquished_spoils_share";
    private const string NavalReinforcementKey = "uadmc_naval_reinforcement";
    private const string ClassNamingThemesKey = "uadmc_class_naming_themes";
    private const string ForeignPortCapacityModeKey = "uadmc_foreign_port_capacity_mode";
    private const string ArmyLogisticsModeKey = "uadmc_army_logistics_mode";
    private const string MineWarfareDisabledKey = "uadmc_mine_warfare_disabled";
    private const string SubmarineWarfareDisabledKey = "uadmc_submarine_warfare_disabled";
    private const string CampaignMapWraparoundEnabledKey = "uadmc_campaign_map_wraparound_enabled";
    private const string EarlyCanalOpeningsEnabledKey = "uadmc_early_canal_openings_enabled";
    private const string TechnologySpreadModeKey = "uadmc_technology_spread_mode";
    private const string CampaignEndDateEnabledKey = "uadmc_campaign_end_date_enabled";
    private const string ExperimentalNationShipPaintsEnabledKey = "uadmc_experimental_nation_ship_paints_enabled";
    private const string BattleRuntimeDiagnosticsEnabledKey = "uadmc_battle_runtime_diagnostics_enabled";
    private const string NationShipPaintStringKeyPrefix = "uadmc_nation_ship_paint_";
    private const string DesignShipPaintStringKeyPrefix = "uadmc_design_ship_paint_";
    private const string UserPaintPresetsKey = "uadmc_user_paint_presets";
    ...
    private const string OldPanamaCanalEarlyEnabledKey = "uadmc_panama_canal_early_enabled";
    ...
    private const string MapGeometryKey = "uadmc_map_geometry_mode";
    ...
    // Shared Low/Medium/High level for MC weighting options.
    ...
    internal static bool PortStrikeBalanced
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Port Strike mode {(value ? "Balanced" : "Vanilla")}.");
    ...
    internal static AiFleetCompositionMode AiFleetComposition
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: AI Fleet Mix mode {AiFleetCompositionModeText(value)}.");
    ...
    internal static AiArmsRaceMode AiArmsRace
    {
        ...
        set
        {
            if (value != AiArmsRaceMode.Disabled)
                Melon<MintChipPlusMod>.Logger.Msg("UADMC option: AI Arms Race is retired for now and remains Disabled.");
        }
    }
    ...
    internal static bool AdvancedAiBuilderEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Advanced AI Builder mode {AdvancedAiBuilderModeText(value)}.");
    ...
    internal static bool SmartAiDesignsEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Smart AI Designs mode {SmartAiDesignsModeText(value)}.");
    ...
    internal static bool SmartRefitsEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Smart Refits mode {SmartRefitsModeText(value)}.");
    ...
    internal static bool SeaTransportLossesActiveForcesEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Sea Transport Losses mode {SeaTransportLossesModeText(value)}.");
    ...
    internal static bool AiTaskForceStagingEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: AI Task Force Staging mode {AiTaskForceStagingModeText(value)}.");
    ...
    internal static CampaignNavalMobilityMode CampaignNavalMobility
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Campaign Naval Mobility mode {CampaignNavalMobilityModeText(value)}.");
    ...
    internal static bool TaskForceSustainmentFullEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Task Force Sustainment mode {TaskForceSustainmentModeText(value)}.");
    ...
    internal static bool BattleWeatherAlwaysSunny
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Battle Weather mode {(value ? "Always Sunny" : "Vanilla")}.");
    ...
    internal static AccuracyPenaltyMode DesignAccuracyPenaltyMode
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Crew & Accuracy Balance mode {AccuracyPenaltyModeText(value)}.");
    ...
    internal static BattleTurnMethod BattleReverseMethod
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Battle Reverse-Course method {BattleTurnMethodText(value)}.");
        }
    }
    ...
    internal static bool FollowSteerDampingEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Follow Steering Damping {(value ? "On" : "Off")}.");
        }
    }
    ...
    internal static bool ParallelStationAbreast
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Parallel Station {(value ? "Abreast" : "Astern")}.");
        }
    }
    ...
    internal static bool AiEconomyPrioritiesEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: AI Economy Priorities {(value ? "On" : "Vanilla")}.");
        }
    }
    ...
    internal static bool ShipServiceRecordsEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Ship Service Records {(value ? "On" : "Off")}.");
        }
    }
    ...
    internal static bool ShipResupplyOverrideEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Ship Resupply Override {(value ? "On" : "Off")}.");
        }
    }
    ...
    internal static bool MajorShipTorpedoesRestricted
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: CA+ Torpedoes mode {(value ? "Disallowed" : "Vanilla")}.");
    ...
    internal static bool HullSpeedAdjustmentEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Hull Speed Adjustment mode {HullSpeedAdjustmentModeText(value)}.");
    ...
    internal static bool HullWeightAdjustmentEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Hull Weight Adjustment mode {HullWeightAdjustmentModeText(value)}.");
    ...
    internal static BattleSpottingRangeMode BattleSpottingRange
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Battle Spotting mode {BattleSpottingRangeModeText(value)}.");
    ...
    internal static BattleDamageMode BattleDamage
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Battle Damage mode {BattleDamageModeText(value)}.");
    ...
    internal static RealisticShellDamageMode RealisticShellDamage
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Realistic Shell Damage mode {RealisticShellDamageModeText(value)}.");
    ...
    internal static bool SuperstructureRefitsEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Superstructure Compatibility mode {SuperstructureRefitsModeText(value)}.");
    ...
    internal static bool ShipyardCapacityBalanced
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Suspend Dock Overcapacity mode {(value ? "Automatic" : "Manual")}.");
    ...
    internal static bool MultiYearShipyardRebuildEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Multi-year shipyard rebuild {(value ? "On" : "Vanilla")}.");
    ...
    internal static bool VanquishedSpoilsEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Vanquished spoils {(value ? "On" : "Vanilla")}.");
    ...
    internal static LevelSetting RebuildOverseasWeightLevel
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Overseas capacity weight {LevelText(value)}.");
    ...
    internal static LevelSetting VanquishedSpoilsShareLevel
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Vanquished spoils share {LevelText(value)}.");
    ...
    internal static NavalReinforcementMode NavalReinforcement
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Naval Reinforcement {value}.");
        }
    }
    ...
    internal static bool ClassNamingThemesEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Class naming themes {(value ? "On" : "Off")}.");
    ...
    private const string ShipbuildingCapacityBoostKey = "uadmc_shipbuilding_capacity_boost";
    ...
    internal static ShipbuildingCapacityBoostMode ShipbuildingCapacityBoost
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Shipbuilding Capacity {ShipbuildingCapacityBoostText(value)}.");
    ...
    // Balance: at campaign battle end the MC-winner takes all surrendered ships (captures
    // the loser's, recovers its own). Default on; vanilla leaves surrendered ships as losses.
    private const string SurrenderedShipCaptureKey = "uadmc_surrendered_ship_capture";
    ...
    internal static bool SurrenderedShipCaptureEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Surrendered ship capture {(value ? "On" : "Vanilla")}.");
    ...
    private const string BattleStartEnabledKey = "uadmc_battle_start_defaults";
    ...
    internal static bool BattleStartDefaultsEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Battle start defaults {(value ? "On" : "Off")}.");
        }
    }

    private const string BattleSpeedSyncKey = "uadmc_battle_speed_sync";
    ...
    internal static bool BattleSpeedSyncEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Division speed-sync {(value ? "On" : "Off")}.");
        }
    }
    ...
    internal static ForeignPortCapacityMode ForeignPortCapacity
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Foreign Port Capacity mode {ForeignPortCapacityModeText(value)}.");
    ...
    internal static ArmyLogisticsMode ArmyLogistics
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Army Logistics mode {ArmyLogisticsModeText(value)}.");
    ...
    internal static bool MineWarfareDisabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Mine Warfare mode {(value ? "Disabled" : "Enabled")}.");
    ...
    internal static bool SubmarineWarfareDisabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Submarine Warfare mode {(value ? "Disabled" : "Enabled")}.");
    ...
    internal static MapGeometryMode MapGeometry
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Map Geometry {value}.");
    ...
    internal static bool EarlyCanalOpeningsEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Canal Openings mode {(value ? "Early" : "Historical")}.");
    ...
    internal static TechnologySpreadMode TechnologySpread
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Technology Spread mode {TechnologySpreadModeText(value)}.");
    ...
    internal static bool CampaignEndDateEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Campaign End Date mode {CampaignEndDateModeText(value)}.");
    ...
    internal static bool ExperimentalNationShipPaintsEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Experimental Nation Ship Paints mode {ExperimentalNationShipPaintsModeText(value)}.");
    ...
    internal static bool BattleRuntimeDiagnosticsEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Battle Runtime Diagnostics mode {BattleRuntimeDiagnosticsModeText(value)}.");
        }
    }
    ...
    internal static bool SetNationShipPaintString(string nationKey, string value, bool logChange)
    {
        ...
        if (logChange)
            Melon<MintChipPlusMod>.Logger.Msg(
                $"UADMC option: Nation Ship Paints updated {NormalizeNationPaintKey(nationKey)} paint string.");
        return true;
    }
    ...
    internal static bool SetDesignShipPaintString(string designKey, string value, bool logChange)
    {
        ...
        if (logChange)
            Melon<MintChipPlusMod>.Logger.Msg(
                $"UADMC option: Design Ship Paints updated for design {designKey}.");
        return true;
    }
    ...
    private static bool PersistUserPaintPresets(List<Color32> presets, string changeDescription)
    {
        ...
        PlayerPrefs.Save();
        Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: user paint presets {changeDescription} ({presets.Count}/{MaxUserPaintPresets}).");
        return true;
    }
    ...
    {
        Melon<MintChipPlusMod>.Logger.Msg($"UADMC settings ({context}): {CurrentSettingsText()}.");
    }
    ...
    private const string AllyShipPurchaseKey = "uadmc_ally_ship_purchase";
    ...
    internal static bool AllyShipPurchaseEnabled
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Ally Ship Purchase {(value ? "On" : "Off")}.");
        }
    }
    ...
    private const string AllyPremiumLevelKey = "uadmc_ally_premium_level";
    ...
    internal static LevelSetting AllyPremiumLevel
    {
        ...
        set
        {
            ...
            PlayerPrefs.Save();
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: Ally Build Premium {LevelText(value)}.");
        }
    }
