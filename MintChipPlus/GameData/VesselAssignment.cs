...
//
// Heavy logging (prefix UADMC_VASSIGN) on every path we have not yet proven at runtime — especially the
...
{
    private static void Log(string m) => Melon<MintChipPlusMod>.Logger.Msg("UADMC_VASSIGN " + m);
