...
// final random surface-type pick with a deficit-weighted pick when MC's AI
...
{
    private const string LogPrefix = "UADMC AI Build weighted type pick";
    ...
    private static bool Prepare()
    {
        ...
        if (!available && !loggedMissingTarget)
        {
            ...
            Melon<MintChipPlusMod>.Logger.Warning(
                "UADMC AI Build weighted type pick: BuildNewShips ship-type predicate target not found; weighted picker disabled for this runtime.");
        }
