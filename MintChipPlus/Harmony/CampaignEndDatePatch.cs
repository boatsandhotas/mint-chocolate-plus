...
internal static class CampaignEndDatePatch
{
    ...
    private static void LogSuppressedPopup()
    {
        ...
        Melon<MintChipPlusMod>.Logger.Msg(
            $"UADMC campaign end date: suppressed vanilla {VanillaRetirementYear} retirement popup at {CampaignDateText(campaign)}; campaign continues.");
    }
    ...
    private static void LogBlockedFinish(CampaignController campaign)
    {
        ...
        Melon<MintChipPlusMod>.Logger.Msg(
            $"UADMC campaign end date: blocked vanilla {VanillaRetirementYear} retirement finish at {CampaignDateText(campaign)}; campaign continues.");
    }
