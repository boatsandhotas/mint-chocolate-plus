...
internal static class BattleWeaponRangeUiPatch
{
    ...
    private static bool Prepare()
    {
        bool available = WeaponRowCallbackMethod != null &&
                         ...
                         TempObjGetter != null;
        if (!available)
            Melon<MintChipPlusMod>.Logger.Warning("UADMC battle weapon range UI unavailable: RefreshShipInfo weapon callback not found.");
    ...
    private static void LogActiveOnce()
    {
        ...
        loggedActive = true;
        Melon<MintChipPlusMod>.Logger.Msg("UADMC battle weapon range UI active: patched weapon accuracy rows.");
    }
