...
// Pure logging, NO game state is modified. Every line is prefixed "UADMC_SUBPROBE"
...
[HarmonyPatch]
internal static class UADMC_SubAssignProbePatch
{
    ...
    private static void Log(string msg) => Melon<MintChipPlusMod>.Logger.Msg("UADMC_SUBPROBE " + msg);
