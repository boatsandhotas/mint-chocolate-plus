...
internal static class CampaignMinefieldDamagePatch
{
    ...
    private static void LogFirstSuppression()
    {
        ...
        Melon<MintChipPlusMod>.Logger.Msg("UADMC mine warfare: minefield damage suppressed because Mine Warfare is Disabled.");
    }
}
...
internal static class DesignMinePartAvailabilityPatch
{
    ...
    private static void LogFirstPart(PartData part)
    {
        ...
        Melon<MintChipPlusMod>.Logger.Msg($"UADMC mine warfare: hiding mine-related designer parts. First blocked part: {MineWarfareDetector.PartLabel(part)}.");
    }
}
...
internal static class DesignMineComponentAvailabilityPatch
{
    ...
    private static void LogFirstComponent(ComponentData component)
    {
        ...
        Melon<MintChipPlusMod>.Logger.Msg($"UADMC mine warfare: hiding mine-related designer components. First blocked component: {MineWarfareDetector.ComponentLabel(component)}.");
    }
}
