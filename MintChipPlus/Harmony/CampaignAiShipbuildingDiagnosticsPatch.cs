...
{
    private const string LogPrefix = "UADMC ai-build";
...
internal static class CampaignAiShipbuildingSummaryNextTurnCompletionPatch
{
    private static bool Prepare()
    {
        ...
        if (!available)
            Melon<MintChipPlusMod>.Logger.Warning("UADMC ai-build: NextTurn MoveNext target not found; summary flush will be skipped.");
        return available;
    }
