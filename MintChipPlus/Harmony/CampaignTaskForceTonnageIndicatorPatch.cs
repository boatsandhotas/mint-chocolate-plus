...
{
    private const string FillImageName = "UADMC_TaskForceTonnageFill";
    ...
    internal static void SyncWrappedClone(ShipUI source, ShipUI copy)
    {
        ...
        catch (Exception ex)
        {
            Melon<MintChipPlusMod>.Logger.Warning(
                $"UADMC task-force tonnage indicator clone sync failed. {ex.GetType().Name}: {ex.Message}");
        }
    }
    ...
    private static void RefreshTaskForceIndicators(MapUI? mapUi)
    {
        ...
        {
            Melon<MintChipPlusMod>.Logger.Warning(
                $"UADMC task-force tonnage indicators failed; leaving vanilla task-force icons intact. {ex.GetType().Name}: {ex.Message}");
        }
    }
    ...
    private static void LogResolvedShipGroupsGetter(MethodInfo getter, object value, int count)
    {
        ...
        Melon<MintChipPlusMod>.Logger.Msg(
            $"UADMC task-force tonnage indicators resolved MapUI ship-groups accessor '{getter.Name}'; " +
    ...
    private static void LogShipGroupsGetterFailureOnce(MethodInfo getter, Exception ex)
    {
        ...
        Melon<MintChipPlusMod>.Logger.Warning(
            $"UADMC task-force tonnage indicators could not invoke MapUI ship-groups accessor '{getter.Name}'. " +
    ...
    private static void LogResolvedShipGroupsField(FieldInfo field, string method)
    {
        ...
        Melon<MintChipPlusMod>.Logger.Msg(
            $"UADMC task-force tonnage indicators resolved MapUI ship-groups field '{field.Name}' by {method}; " +
    ...
    private static void DumpMapUiFieldsOnce(MapUI mapUi, string reason)
    {
        ...
        dump.Append($"UADMC task-force tonnage indicators MapUI field dump ({reason}).");
        ...
        Melon<MintChipPlusMod>.Logger.Warning(dump.ToString());
    }
    ...
    private static void LogSummaryOnce(int updated, int fullStacks, float maxTonnage)
    {
        ...
        Melon<MintChipPlusMod>.Logger.Msg(
            $"UADMC task-force tonnage indicators: updated {updated} map markers; " +
    ...
    private static void LogMissingShipGroups(string reason)
    {
        ...
        Melon<MintChipPlusMod>.Logger.Warning(
            $"UADMC task-force tonnage indicators unavailable because MapUI.shipGroups {reason}.");
    }
