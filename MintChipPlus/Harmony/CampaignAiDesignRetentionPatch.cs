...
{
    private const string LogPrefix = "UADMC AI Design retention";
...
internal static class CampaignAiDesignRetentionDeleteOldDesignsPatch
{
    private static bool Prepare()
    {
        ...
        if (!available)
            Melon<MintChipPlusMod>.Logger.Warning("UADMC AI Design retention: DeleteOldDesigns target not found; retention guard disabled.");
...
internal static class CampaignAiDesignRetentionDeleteDesignPatch
{
    private static bool Prepare()
    {
        bool available = TargetMethod() != null;
        if (!available)
            Melon<MintChipPlusMod>.Logger.Warning("UADMC AI Design retention: DeleteDesign target not found; retention guard disabled.");
...
internal static class CampaignAiDesignRetentionShipErasePatch
{
    private static bool Prepare()
    {
        bool available = TargetMethod() != null;
        if (!available)
            Melon<MintChipPlusMod>.Logger.Warning("UADMC AI Design retention: Ship.Erase target not found; erase guard disabled.");
