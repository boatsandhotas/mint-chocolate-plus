...
using Il2CppTMPro;
using MelonLoader;
using PaintArea = MintChipPlus.Harmony.DesignHullColorProofPatch.PaintArea;
...
// Patch intent: expose MC balance controls in a vanilla-like settings panel.
...
internal static class InGameOptionsMenuPatch
{
    ...
    private const string ButtonName = "UADMC_OptionsButton";
    private const string PaintLauncherButtonName = "UADMC_PaintLauncherButton";
    private const string ThemeLauncherButtonName = "UADMC_ThemeLauncherButton";
    private const string MenuName = "UADMC Options";
    private const string ContentName = "UADMC_OptionsContent";
    private const string BattleWeatherOptionName = "UADMC_Option_BattleWeather";
    private const string BattleSpottingRangeOptionName = "UADMC_Option_BattleSpottingRange";
    private const string BattleDamageOptionName = "UADMC_Option_BattleDamage";
    private const string RealisticShellDamageOptionName = "UADMC_Option_RealisticShellDamage";
    private const string DesignAccuracyPenaltiesOptionName = "UADMC_Option_DesignAccuracyPenalties";
    private const string PortStrikeOptionName = "UADMC_Option_PortStrike";
    private const string AiFleetCompositionOptionName = "UADMC_Option_AiFleetComposition";
    private const string AdvancedAiBuilderOptionName = "UADMC_Option_AdvancedAiBuilder";
    private const string SmartAiDesignsOptionName = "UADMC_Option_SmartAiDesigns";
    private const string SharedDesignsUsageOptionName = "UADMC_Option_SharedDesignsUsage";
    private const string SmartRefitsOptionName = "UADMC_Option_SmartRefits";
    private const string SeaTransportLossesOptionName = "UADMC_Option_SeaTransportLosses";
    private const string AiTaskForceStagingOptionName = "UADMC_Option_AiTaskForceStaging";
    private const string CampaignNavalMobilityOptionName = "UADMC_Option_CampaignNavalMobility";
    private const string TaskForceSustainmentOptionName = "UADMC_Option_TaskForceSustainment";
    private const string HullSpeedAdjustmentOptionName = "UADMC_Option_HullSpeedAdjustment";
    private const string HullWeightAdjustmentOptionName = "UADMC_Option_HullWeightAdjustment";
    private const string MajorShipTorpedoesOptionName = "UADMC_Option_MajorShipTorpedoes";
    private const string MultiYearShipyardRebuildOptionName = "UADMC_Option_MultiYearShipyardRebuild";
    private const string AiEconomyPrioritiesOptionName = "UADMC_Option_AiEconomyPriorities";
    private const string ShipResupplyOverrideOptionName = "UADMC_Option_ShipResupplyOverride";
    private const string ShipServiceRecordsOptionName = "UADMC_Option_ShipServiceRecords";
    private const string RebuildOverseasWeightOptionName = "UADMC_Option_RebuildOverseasWeight";
    private const string VanquishedSpoilsOptionName = "UADMC_Option_VanquishedSpoils";
    private const string VanquishedSpoilsShareOptionName = "UADMC_Option_VanquishedSpoilsShare";
    private const string NavalReinforcementOptionName = "UADMC_Option_NavalReinforcement";
    private const string ClassNamingThemesOptionName = "UADMC_Option_ClassNamingThemes";
    private const string ShipbuildingCapacityBoostOptionName = "UADMC_Option_ShipbuildingCapacityBoost";
    private const string SurrenderedShipCaptureOptionName = "UADMC_Option_SurrenderedShipCapture";
    private const string BattleStartDefaultsOptionName = "UADMC_Option_BattleStartDefaults";
    private const string BattleStartAmmoOptionName = "UADMC_Option_BattleStartAmmo";
    private const string BattleStartAvoidTorpOptionName = "UADMC_Option_BattleStartAvoidTorp";
    private const string BattleStartAvoidShipOptionName = "UADMC_Option_BattleStartAvoidShip";
    private const string BattleStartAutoLeaderOptionName = "UADMC_Option_BattleStartAutoLeader";
    private const string BattleStartFireTorpOptionName = "UADMC_Option_BattleStartFireTorp";
    private const string BattleStartFormationOptionName = "UADMC_Option_BattleStartFormation";
    private const string BattleSpeedSyncOptionName = "UADMC_Option_BattleSpeedSync";
    private const string BattleReverseMethodOptionName = "UADMC_Option_BattleReverseMethod";
    private const string FollowSteerDampingOptionName = "UADMC_Option_FollowSteerDamping";
    private const string ParallelStationOptionName = "UADMC_Option_ParallelStation";
    private const string SuperstructureRefitsOptionName = "UADMC_Option_SuperstructureRefits";
    private const string ShipyardCapacityOptionName = "UADMC_Option_ShipyardCapacity";
    private const string ForeignPortCapacityOptionName = "UADMC_Option_ForeignPortCapacity";
    private const string ArmyLogisticsOptionName = "UADMC_Option_ArmyLogistics";
    private const string CampaignMapWraparoundOptionName = "UADMC_Option_CampaignMapWraparound";
    private const string CanalOpeningsOptionName = "UADMC_Option_CanalOpenings";
    private const string TechnologySpreadOptionName = "UADMC_Option_TechnologySpread";
    private const string CampaignEndDateOptionName = "UADMC_Option_CampaignEndDate";
    private const string MineWarfareOptionName = "UADMC_Option_MineWarfare";
    private const string SubmarineWarfareOptionName = "UADMC_Option_SubmarineWarfare";
    private const string ExperimentalNationShipPaintsOptionName = "UADMC_Option_ExperimentalNationShipPaints";
    private const string BattleRuntimeDiagnosticsOptionName = "UADMC_Option_BattleRuntimeDiagnostics";
    private const string NationShipPaintsSectionName = "UADMC_Option_NationShipPaints";
    ...
    // Confirmed in-game 0.5.243 (UADMC_SPEEDDIAG): Ship.SpeedMax(false) is in m/s; displayed knots =
    ...
    private const string BattlePanelXKey = "uadmc_battle_panel_x";
    private const string BattlePanelYKey = "uadmc_battle_panel_y";
    ...
    private static void TrySetup()
    {
        ...
        try
        {
            ...
            catch (Exception ex) { Melon<MintChipPlusMod>.Logger.Warning($"UADMC paint launcher setup skipped. {ex.GetType().Name}: {ex.Message}"); }
            try { SetupThemeLauncherButton(); }
            catch (Exception ex) { Melon<MintChipPlusMod>.Logger.Warning($"UADMC theme launcher setup skipped. {ex.GetType().Name}: {ex.Message}"); }
        }
        catch (Exception ex)
        {
            Melon<MintChipPlusMod>.Logger.Warning($"UADMC options menu setup skipped. {ex.GetType().Name}: {ex.Message}");
        }
    }
    ...
    private static void SetupLauncherButton()
    {
        ...
        initialized = true;
        RefreshLauncherButton();
        Melon<MintChipPlusMod>.Logger.Msg("UADMC options menu button added.");
    }
    ...
    private static void OpenMenu()
    {
        ...
        {
            Melon<MintChipPlusMod>.Logger.Warning("UADMC options menu skipped. Popup template not found.");
            return;
        }
    ...
    private static void BuildSettingsWindow(GameObject window)
    {
        ...
        Text title = AddText(contentRoot.transform, "UAD:MC Options", 18, TextAnchor.MiddleLeft);
        title.name = "UADMC_OptionsTitle";
        AddLayout(title.gameObject, minHeight: 24f, preferredHeight: 24f, flexibleWidth: 1f);

        GameObject body = new("UADMC_OptionsBody");
        ...
        GameObject footer = new("UADMC_OptionsFooter");
    ...
    {
        GameObject sections = new("UADMC_OptionsSections");
    ...
    {
        GameObject pane = new("UADMC_OptionsPane");
        ...
        switch (selectedSection)
        {
            ...
            case Section.Campaign:
                ...
                AddSegmentedOption(
                    ...
                    "Advanced AI Builder",
                    "Enhanced lets MC help AI design books with shared-design blueprint adaptation, missing-type recovery, and stale-design refreshes. Vanilla keeps the game's original design-generation cadence and exact shared-design checks.",
                    true,
                ...
                AddSegmentedOption(
                    ...
                    "Smart AI Designs",
                    "Experimental replaces vanilla's random AI new-design fallback with one deterministic MC ship-design attempt after shared and predefined designs fail. Vanilla keeps the game's original random fallback.",
                    true,
                ...
                AddSegmentedOption(
                    ...
                    "Smart Refits",
                    "Enhanced replaces vanilla AI random refits with MC's conservative refit pass and enables the player Smart Refit constructor button. Vanilla restores the game's original AI refit path and hides the MC button.",
                    true,
            ...
            case Section.SwitchNation:
            {
                ...
                GameObject row = new("UADMC_SwitchNationRow");
    ...
    {
        GameObject row = new("UADMC_NationShipPaintsHeader");
    ...
    private static void AddNationShipPaintRow(Transform parent, DesignHullColorProofPatch.NationPaintUiInfo nation)
    {
        ...
        GameObject spacer = new("UADMC_PaintRowSpacer");
    ...
    private static void AddPaintSwatch(Transform parent, DesignHullColorProofPatch.NationPaintUiInfo nation, PaintArea channel, Color32 color)
    {
        ...
        GameObject swatchObject = new($"UADMC_Swatch_{nation.Key}_{channel}");
    ...
    private static Button AddActionButton(Transform parent, string label, Action onPress, float width)
    {
        ...
        GameObject buttonObject = buttonTemplate != null ? UnityEngine.Object.Instantiate(buttonTemplate) : new GameObject($"UADMC_Button_{label}");
        buttonObject.transform.SetParent(parent, false);
        buttonObject.name = $"UADMC_Button_{label.Replace(" ", string.Empty)}";
        buttonObject.SetActive(true);
    ...
    {
        GameObject textObject = new($"UADMC_Text_{text.Replace(" ", string.Empty).Replace(":", string.Empty)}");
    ...
    private static void SetDesignAccuracyPenaltiesMode(ModSettings.AccuracyPenaltyMode mode)
    {
        ...
        {
            Melon<MintChipPlusMod>.Logger.Warning("UADMC option: Crew & Accuracy Balance cannot be changed while a battle is loading or active.");
            RefreshMenu();
            RefreshLauncherButton();
            return;
        }
    ...
    private static void AddBattleDefaultsClassRow(Transform pane)
    {
        ...
        GameObject row = new("UADMC_BattleDefaultsClass");
    ...
    private static void TrySetupBattleInputs()
    {
        ...
        try
        {
            ...
            battlePanel = new GameObject("UADMC_BattleHelmPanel");
            ...
            GameObject header = new("UADMC_BattleHelmHeader");
            ...
            BuildBattleRow("UADMC_BattleSpeedRow", "kn", true, out battleSpeedText, out battleSpeedInput);
            BuildBattleRow("UADMC_BattleCourseRow", "deg", false, out battleCourseText, out battleCourseInput);
            ...
            Melon<MintChipPlusMod>.Logger.Msg("UADMC battle helm panel created (draggable, paste-enabled).");
        }
        catch (Exception ex)
        {
            Melon<MintChipPlusMod>.Logger.Warning($"UADMC battle inputs setup failed: {ex.GetType().Name}: {ex.Message}");
        }
    }
    ...
    {
        GameObject row = new("UADMC_BattleTurnRow");
        row.transform.SetParent(battlePanel!.transform, false);
        Image rbg = row.AddComponent<Image>();
        rbg.color = new Color(0f, 0f, 0f, 0.35f);
    ...
    {
        GameObject go = new("UADMC_PanelBtn");
    ...
    private static void RefreshBattleInputs()
    {
        try
        {
            ...
            if (currentUi != null && GameManager.IsBattle)
            {
                ...
                // false. Active combat = neither. (UADMC_HELMVIS logs the flags on change to confirm.)
            ...
            if (ModSettings.BattleRuntimeDiagnosticsEnabled && (++speedDiagTick % 90) == 0)
            {
                ...
                Melon<MintChipPlusMod>.Logger.Msg(
                    $"UADMC_SPEEDDIAG game={BattleGameSpeedText()} slider={slVal:0.###}[{slMin:0.##}..{slMax:0.##}] " +
    ...
    private static void ApplySpeedToSelection(float knots)
    {
        try
        {
            ...
            // UADMC_SPEEDDIAG line shows the fully-settled values.)
            ...
            Melon<MintChipPlusMod>.Logger.Msg(
                $"UADMC battle speed: typed={knots:0.0}kn maxKn={maxKn:0.0} frac={frac:0.00} slider[{sMin:0.##}..{sMax:0.##}]=set{sVal:0.###}->now{afterSliderVal:0.###} " +
                $"curBefore={before:0.0} desRawAfter={afterDesRaw:0.00} desDispAfter={afterDesDisp:0.00} game={gameTxt} appliedViaSlider={applied}");
        }
        catch (Exception ex)
        {
            Melon<MintChipPlusMod>.Logger.Warning($"UADMC battle speed apply failed: {ex.GetType().Name}: {ex.Message}");
        }
    }
    ...
    private static void LogHelmVisibilityIfChanged(bool hudUp, bool starting, bool finishing, int selCount, bool show)
    {
        ...
        lastHelmVisSig = sig;
        Melon<MintChipPlusMod>.Logger.Msg(
            $"UADMC_HELMVIS hudUp={hudUp} battleStart={starting} battleFinishing={finishing} selCount={selCount} -> show={show}");
    }
    ...
    private static void ApplyCourseToSelection(float course)
    {
        try
        {
            ...
            Melon<MintChipPlusMod>.Logger.Msg($"UADMC battle course: {course:0}° -> {n} division(s).");
        }
        catch (Exception ex)
        {
            Melon<MintChipPlusMod>.Logger.Warning($"UADMC battle course apply failed: {ex.GetType().Name}: {ex.Message}");
        }
    }
    ...
    private static void RefreshConstructorAvailabilityUi(string optionName)
    {
        try
        {
            ...
            {
                Melon<MintChipPlusMod>.Logger.Msg(
                    $"UADMC option: stored {optionName} mode change; constructor UI is not active.");
                return;
            }
            ...
            catch (Exception ex) { Melon<MintChipPlusMod>.Logger.Warning($"UADMC option: constructor info refresh failed. {ex.GetType().Name}: {ex.Message}"); }

            try { RefreshConstructorParts?.Invoke(ui, Array.Empty<object>()); }
            catch (Exception ex) { Melon<MintChipPlusMod>.Logger.Warning($"UADMC option: constructor parts refresh failed. {ex.GetType().Name}: {ex.Message}"); }

            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: refreshed constructor availability UI after {optionName} mode change.");
        }
        catch (Exception ex)
        {
            Melon<MintChipPlusMod>.Logger.Warning(
                $"UADMC option: constructor availability refresh skipped. {ex.GetType().Name}: {ex.Message}");
        }
    }
    ...
    private static void RefreshSubmarineWarfareUi()
    {
        try
        {
            ...
            catch (Exception ex) { Melon<MintChipPlusMod>.Logger.Warning($"UADMC option: submarine warfare country-info refresh failed. {ex.GetType().Name}: {ex.Message}"); }

            try { ui.SubmarineWindow?.Refresh(); }
            catch (Exception ex) { Melon<MintChipPlusMod>.Logger.Warning($"UADMC option: submarine warfare window refresh failed. {ex.GetType().Name}: {ex.Message}"); }

            Melon<MintChipPlusMod>.Logger.Msg("UADMC option: refreshed submarine warfare UI after mode change.");
        }
        catch (Exception ex)
        {
            Melon<MintChipPlusMod>.Logger.Warning(
                $"UADMC option: submarine warfare UI refresh skipped. {ex.GetType().Name}: {ex.Message}");
        }
    }
    ...
    private static void RefreshCampaignCostUi(string reason = "Suspend Dock Overcapacity mode change")
    {
        try
        {
            ...
            try { ui.CountryInfo?.Refresh(); }
            catch (Exception ex) { Melon<MintChipPlusMod>.Logger.Warning($"UADMC option: country-info cost refresh failed. {ex.GetType().Name}: {ex.Message}"); }
            ...
            catch (Exception ex) { Melon<MintChipPlusMod>.Logger.Warning($"UADMC option: finances cost refresh failed. {ex.GetType().Name}: {ex.Message}"); }

            try { ui.FleetWindow?.Refresh(false); }
            catch (Exception ex) { Melon<MintChipPlusMod>.Logger.Warning($"UADMC option: fleet cost refresh failed. {ex.GetType().Name}: {ex.Message}"); }

            try { ui.SubmarineWindow?.Refresh(); }
            catch (Exception ex) { Melon<MintChipPlusMod>.Logger.Warning($"UADMC option: submarine cost refresh failed. {ex.GetType().Name}: {ex.Message}"); }

            try { ui.RefreshCampaignUI(); }
            catch (Exception ex) { Melon<MintChipPlusMod>.Logger.Warning($"UADMC option: campaign UI refresh failed. {ex.GetType().Name}: {ex.Message}"); }

            Melon<MintChipPlusMod>.Logger.Msg($"UADMC option: refreshed campaign cost UI after {reason}.");
        }
        catch (Exception ex)
        {
            Melon<MintChipPlusMod>.Logger.Warning(
                $"UADMC option: campaign cost UI refresh skipped. {ex.GetType().Name}: {ex.Message}");
        }
    }
    ...
    private static void SetupThemeLauncherButton()
    {
        ...
        if (options == null || helpButton == null)
        {
            Melon<MintChipPlusMod>.Logger.Warning("UADMC theme launcher: Options/Help not found at setup.");
            return;
        }
        ...
        MatchButtonSizing(buttonObject, helpButton);
        RemoveTooltipHandlers(buttonObject);
        AddTooltip(buttonObject, () => "UAD:MC Class Naming Themes" + ThemeTooltipSuffix());
        ...
        Melon<MintChipPlusMod>.Logger.Msg($"UADMC theme launcher button added (button={(themeLauncherButton != null)}).");
    }
    ...
    private static void RefreshThemeLauncherButton()
    {
        if (themeLauncherButton == null)
        {
            if (!loggedThemeLauncherNull)
            {
                ...
                Melon<MintChipPlusMod>.Logger.Warning("UADMC theme launcher: button is null (not created).");
            }
            return;
        }
        ...
        if (show && !loggedThemeLauncherShow)
        {
            ...
            Melon<MintChipPlusMod>.Logger.Msg(
                $"UADMC theme launcher shown: active={go.activeSelf} parent={go.transform.parent?.name} sibling={go.transform.GetSiblingIndex()} pos={(r != null ? r.anchoredPosition.ToString() : "?")}.");
        }
        if (!show)
            CloseThemePanel();
    }
    ...
    private static void OpenThemePanel()
    {
        ...
        {
            Melon<MintChipPlusMod>.Logger.Warning("UADMC naming themes: no design open in the constructor.");
            return;
        }
        ...
        themePanel = new GameObject("UADMC_ClassThemePanel");
    ...
    {
        GameObject scrollGo = new("UADMC_ThemeScroll");
    ...
    private static void SetupPaintLauncherButton()
    {
        ...
        MatchButtonSizing(buttonObject, helpButton);
        RemoveTooltipHandlers(buttonObject);
        AddTooltip(buttonObject, () => $"UAD:MC Ship Paints{ConstructorPaintTooltipSuffix()}");
    ...
    private static void OpenConstructorPaintPanel()
    {
        ...
        {
            Melon<MintChipPlusMod>.Logger.Warning("UADMC ship paints: no matching nation paint scheme for the current player.");
            return;
        }
        ...
        constructorPaintPanel = new GameObject("UADMC_ConstructorPaintPanel");
        ...
        Melon<MintChipPlusMod>.Logger.Msg(
            hasDesign
                ? $"UADMC ship paints panel opened for {nation.Label}, class {panelDesignName} ({panelDesignKey})."
                : $"UADMC ship paints panel opened for {nation.Label} (no design context)."
        );
    }

    private static void BuildPanelChannelHeader(Transform parent)
    {
        GameObject row = new("UADMC_PanelChannelHeader");
        row.transform.SetParent(parent, false);
        Image rowImage = row.AddComponent<Image>();
        rowImage.color = new Color(0f, 0f, 0f, 0f);
        rowImage.raycastTarget = false;
    ...
    {
        GameObject row = new("UADMC_PanelTargetRow");
        row.transform.SetParent(parent, false);
        Image rowImage = row.AddComponent<Image>();
        rowImage.color = new Color(0f, 0f, 0f, 0f);
        rowImage.raycastTarget = false;
    ...
    {
        GameObject swatchObject = new($"UADMC_PanelSwatch_{channel}");
        swatchObject.transform.SetParent(parent, false);
        Image border = swatchObject.AddComponent<Image>();
        border.color = SwatchBorder;
    ...
    private static void PromoteDesignToNation(string designKey, string designName, DesignHullColorProofPatch.NationPaintUiInfo nation)
    {
        ...
        if (changed)
        {
            ...
            Melon<MintChipPlusMod>.Logger.Msg(
                $"UADMC ship paints: promoted design {designName} ({designKey}) overrides to nation {nation.Label}.");
        }
        else
        {
            Melon<MintChipPlusMod>.Logger.Msg(
                $"UADMC ship paints: no per-class overrides to promote for {designName}.");
        }
    ...
    private static void SwapDesignAndNation(string designKey, string designName, DesignHullColorProofPatch.NationPaintUiInfo nation)
    {
        ...
        {
            Melon<MintChipPlusMod>.Logger.Msg(
                $"UADMC ship paints: swap is a no-op — {nation.Label} and {designName} share identical paint strings.");
            return;
        }
        ...
        Melon<MintChipPlusMod>.Logger.Msg(
            $"UADMC ship paints: swapped nation {nation.Label} ↔ design {designName} ({designKey}).");
    ...
    private static void OpenPaintPicker(DesignHullColorProofPatch.NationPaintUiInfo nation, PaintArea channel, string designKey, string designName)
    {
        ...
        paintPicker = new GameObject("UADMC_PaintPicker");
        ...
        GameObject previewRow = new("UADMC_PaintPreviewRow");
        ...
        GameObject buttonsRow = new("UADMC_PaintPickerButtons");
        ...
        Melon<MintChipPlusMod>.Logger.Msg(
            editingDesign
                ? $"UADMC paint picker opened for class {designName} ({designKey}) / {ChannelLabel(channel)} at {HexFor(current)}."
                : $"UADMC paint picker opened for nation {nation.Label} / {ChannelLabel(channel)} at {HexFor(current)}.");
    }
    ...
    {
        GameObject row = new($"UADMC_PaintSlider_{channelLabel}");
        row.transform.SetParent(parent, false);
        Image rowImage = row.AddComponent<Image>();
        rowImage.color = new Color(0f, 0f, 0f, 0f);
        rowImage.raycastTarget = false;
    ...
    private static void ApplyPaintPicker()
    {
            ...
            : DesignHullColorProofPatch.TryResolveAllNationPaintColors(pickerNation.Key, out effective))
        {
            if (effective.TryGetValue(pickerChannel, out Color32 channelColor))
            {
                ...
                Melon<MintChipPlusMod>.Logger.Msg(
                    $"UADMC option: Ship Paints applied {targetLabel} / {ChannelLabel(pickerChannel)} = {HexFor(channelColor)}.");
            }
        }
    ...
    {
        GameObject fieldObject = new("UADMC_HexInput");
    ...
    {
        GameObject presetsRow = new("UADMC_PaintPickerPresets");
    ...
    {
        pickerUserPresetsRow = new GameObject("UADMC_PaintPickerUserPresets");
    ...
    private static Sprite EnsurePaintIconSprite()
    {
        ...
        paintIconSprite.name = "UADMC_PaintIconSprite";
        return paintIconSprite;
    }
    ...
    private static Sprite EnsureColorWheelSprite()
    {
        ...
        colorWheelSprite.name = "UADMC_ColorWheelSprite";
        return colorWheelSprite;
    }
}
