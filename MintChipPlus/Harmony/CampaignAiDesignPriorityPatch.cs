...
{
    private const string LogPrefix = "UADMC AI Design priority";
    ...
    private static void Log(string message)
        => Melon<MintChipPlusMod>.Logger.Msg($"{LogPrefix}: {message}");
...
internal static class CampaignAiDesignPriorityMissingTypePredicatePatch
{
    ...
    private static bool Prepare()
    {
        ...
        if (!available && !loggedMissingTarget)
        {
            ...
            Melon<MintChipPlusMod>.Logger.Warning("UADMC AI Design priority: GenerateRandomDesigns missing-type predicate target not found; missing-type priority disabled for this runtime.");
        }
        else if (available && !loggedAttachedTarget)
        {
            loggedAttachedTarget = true;
            Melon<MintChipPlusMod>.Logger.Msg("UADMC AI Design priority: attached GenerateRandomDesigns missing-type predicate hook.");
        }
...
internal static class CampaignAiDesignPriorityReplacementTypePredicatePatch
{
    ...
    private static bool Prepare()
    {
        ...
        {
            loggedMissingTarget = true;
            Melon<MintChipPlusMod>.Logger.Warning("UADMC AI Design priority: GenerateRandomDesigns replacement-type predicate target not found; replacement priority disabled for this runtime.");
        }
        else if (available && !loggedAttachedTarget)
        {
            loggedAttachedTarget = true;
            Melon<MintChipPlusMod>.Logger.Msg("UADMC AI Design priority: attached GenerateRandomDesigns replacement-type predicate hook.");
        }
...
internal static class CampaignAiDesignPriorityStaleDesignPredicatePatch
{
    ...
    private static bool Prepare()
    {
        ...
        {
            loggedMissingTarget = true;
            Melon<MintChipPlusMod>.Logger.Warning("UADMC AI Design priority: GenerateRandomDesigns stale-design predicate target not found; stale-design priority disabled for this runtime.");
        }
        else if (available && !loggedAttachedTarget)
        {
            loggedAttachedTarget = true;
            Melon<MintChipPlusMod>.Logger.Msg("UADMC AI Design priority: attached GenerateRandomDesigns stale-design predicate hook.");
        }
