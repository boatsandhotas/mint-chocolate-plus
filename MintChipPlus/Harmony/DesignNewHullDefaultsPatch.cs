...
{
    private const string LogPrefix = "UADMC designer hull defaults";
    ...
    internal static void LogChoosePartTarget()
    {
        ...
        Melon<MintChipPlusMod>.Logger.Msg($"{LogPrefix}: attached Ui.ChoosePart hull marker.");
    }
    ...
    internal static void LogChangeHullTarget()
    {
        ...
        Melon<MintChipPlusMod>.Logger.Msg($"{LogPrefix}: attached Ship.ChangeHull defaults hook.");
    }
    ...
    internal static void LogAddPartTarget()
    {
        ...
        Melon<MintChipPlusMod>.Logger.Msg($"{LogPrefix}: attached Ship.AddPart armament/equipment/torpedo defaults hook.");
    }
    ...
    internal static void LogUiUpdateTarget()
    {
        ...
        Melon<MintChipPlusMod>.Logger.Msg($"{LogPrefix}: attached Ui.Update deferred armament/equipment/torpedo defaults hook.");
    }
    ...
    private static void WarnSanityOnce(string detail)
    {
        ...
        Melon<MintChipPlusMod>.Logger.Warning($"{LogPrefix}: {detail}");
    }
...
internal static class DesignNewHullDefaultsChoosePartPatch
{
    ...
    private static bool Prepare()
    {
        ...
        if (found)
            ...
            Melon<MintChipPlusMod>.Logger.Warning("UADMC designer hull defaults: Ui.ChoosePart target not found; hull-pick scoping disabled.");
...
internal static class DesignNewHullDefaultsChangeHullPatch
{
    ...
    private static bool Prepare()
    {
        ...
        if (found)
            ...
            Melon<MintChipPlusMod>.Logger.Warning("UADMC designer hull defaults: Ship.ChangeHull target not found; defaults disabled.");
...
internal static class DesignNewHullDefaultsAddPartPatch
{
    ...
    private static bool Prepare()
    {
        ...
        if (found)
            ...
            Melon<MintChipPlusMod>.Logger.Warning("UADMC designer hull defaults: Ship.AddPart target not found; first-gun armament defaults disabled.");
...
internal static class DesignNewHullDefaultsUiUpdatePatch
{
    ...
    private static bool Prepare()
    {
        ...
        if (found)
            ...
            Melon<MintChipPlusMod>.Logger.Warning("UADMC designer hull defaults: Ui.Update target not found; deferred armament defaults disabled.");
