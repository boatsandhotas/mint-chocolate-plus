...
internal static class CampaignSmartAiDesignTryTakePatch
{
    ...
    private static bool Prepare()
    {
        ...
        if (!available)
            Melon<MintChipPlusMod>.Logger.Warning("UADMC smart AI designs: TryTakeSharedDesign target not found; smart fallback disabled.");
...
internal static class CampaignSmartAiDesignRandomShipMoveNextPatch
{
    ...
    private static bool Prepare()
    {
        ...
        if (available)
            ...
            Melon<MintChipPlusMod>.Logger.Warning("UADMC smart AI designs: Ship.GenerateRandomShip MoveNext target not found; smart generator diagnostics disabled.");
...
internal static class CampaignSmartAiDesignSummaryNextTurnCompletionPatch
{
    ...
    private static bool Prepare()
    {
        bool available = TargetMethod() != null;
        if (!available)
            Melon<MintChipPlusMod>.Logger.Warning("UADMC smart AI designs: NextTurn MoveNext target not found; turn summary flush will be skipped.");
