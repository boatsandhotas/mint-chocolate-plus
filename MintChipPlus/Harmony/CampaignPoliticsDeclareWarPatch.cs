...
{
    private const string DeclareWarButtonName = "UADMC_DeclareWar";
    private const string ForcePeaceButtonName = "UADMC_ForcePeace";
    ...
    private static void EnsureDeclareWarButton(CampaignPolitics_ElementUI row)
    {
        ...
        Melon<MintChipPlusMod>.Logger.Msg("UADMC diplomacy: added Declare War button to politics row.");
    }
    ...
    private static void EnsureForcePeaceButton(CampaignPolitics_ElementUI row)
    {
        ...
        Melon<MintChipPlusMod>.Logger.Msg("UADMC diplomacy: added Force Peace button to politics row.");
    }
        ...
        string reason)
    {
        ...
        Melon<MintChipPlusMod>.Logger.Msg($"UADMC diplomacy {actionName} button {state}");
    }
