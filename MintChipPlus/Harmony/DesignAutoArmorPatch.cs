...
{
    private const string LogPrefix = "UADMC designer auto armor";
    private const string ButtonName = "UADMC_GenerateArmor";
    private const string AutoLiteButtonName = "UADMC_AutoDesignLite";
    private const string SmartRefitButtonName = "UADMC_SmartRefit";
        ...
        try
        {
            ...
            if (source == null)
            {
                if (!loggedMissingButton)
                {
                    ...
                    Melon<MintChipPlusMod>.Logger.Warning($"{LogPrefix}: vanilla button template not found; Generate Armor button disabled.");
                }
...
internal static class DesignAutoArmorConstructorUiPatch
{
    ...
    private static bool Prepare()
    {
        ...
        if (!found)
            Melon<MintChipPlusMod>.Logger.Warning("UADMC designer auto armor: Ui.ConstructorUI target not found; button disabled.");
        return found;
    }
